...
if text == 'compose' or text == 'compoze' or text == 'compus' or text== 'kompoz':
    ...
    mail.ehlo() 
    mail.starttls() 
    mail.login('mstafaerdoann@gmail.com','Cimbom.97' ) 
    mail.sendmail('c.mustafaerdoann@hotmail.com','c.mustafaerdoann@hotmail.com',msg) 
...
if text == 'check'  :
    ...
    username = ('mstafaerdoann@gmail.com')  
    password = ('Cimbom.97') 
...
if text == 'remove' or text == 'remov' or text == 'rimoove' or text == 'remove' or text == 'rimoove' or text == 'are moon':
    ...
    mail.login("mstafaerdoann@gmail.com","Cimbom.97")
    mail.select('Inbox')
    typ, data = mail.search(None, 'from','tarihdergi')
    for num in data[0].split():
        mail.store(num, '+FLAGS', '\\Deleted')
    mail.expunge()
    mail.close()
...
if text == 'search' or text == 'sarch' or text == 'serch':
    ...
    mail.login("mstafaerdoann@gmail.com","Cimbom.97")
    mail.select('Inbox')    
    result, total1 = mail.search(None,'from','info@tarihdergi.com' )
